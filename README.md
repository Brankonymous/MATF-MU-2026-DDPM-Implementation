...
- [`presentation/presentation.ipynb`](presentation/presentation.ipynb) — Quick presentation and sampling demo.
...
![Production EMA samples](results/samples_production.png)
